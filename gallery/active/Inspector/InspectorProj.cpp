...
USEFORM("InspectorImpl.cpp", Inspector); /* TActiveForm: File Type */ /* Inspector: CoClass */
USEFORM("About.cpp", InspectorAbout);
//---------------------------------------------------------------------------
#pragma package(smart_init)
TComModule  InspectorProjModule;
TComModule &_Module = InspectorProjModule;
...
BEGIN_OBJECT_MAP(ObjectMap)
  OBJECT_ENTRY(CLSID_Inspector, TInspectorImpl)
END_OBJECT_MAP()
