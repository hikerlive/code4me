...
#ifndef InspectorImplH
#define InspectorImplH
//---------------------------------------------------------------------------
#include <classes.hpp>
#include <controls.hpp>
#include <stdCtrls.hpp>
#include <forms.hpp>
#include "InspectorProj_TLB.h"
#include <AxCtrls.hpp>
#include <Classes.hpp>
#include <Controls.hpp>
#include <StdCtrls.hpp>
//---------------------------------------------------------------------------
class TInspector : public TActiveForm
{
...
public:		// User declarations
    __fastcall TInspector(HWND ParentWindow);
    __fastcall TInspector(TComponent* AOwner): TActiveForm(AOwner) {};
};
//---------------------------------------------------------------------------
extern PACKAGE TInspector *Inspector;
//---------------------------------------------------------------------------



//---------------------------------------------------------------------------
class ATL_NO_VTABLE TInspectorImpl:
  VCLCONTROL_IMPL(TInspectorImpl, Inspector, TInspector, IInspector, DIID_IInspectorEvents)
{
...
//
BEGIN_COM_MAP(TInspectorImpl)
  VCL_CONTROL_COM_INTERFACE_ENTRIES(IInspector)
END_COM_MAP()
...
//
BEGIN_PROPERTY_MAP(TInspectorImpl)
  // PROP_PAGE(CLSID_InspectorPage)
END_PROPERTY_MAP()
...
DECLARE_VCL_CONTROL_PERSISTENCE(TInspectorImpl, TInspector);
...
// your control.
//
DECLARE_ACTIVEXCONTROL_REGISTRY("InspectorProj.Inspector", 1);
