...
#include <forms.hpp>
#include "GuideProj_TLB.h"
#include <AxCtrls.hpp>
#include <Classes.hpp>
#include <Controls.hpp>
#include <StdCtrls.hpp>
//---------------------------------------------------------------------------
class TGuide : public TActiveForm
{
...
public:		// User declarations
    __fastcall TGuide(HWND ParentWindow);
    __fastcall TGuide(TComponent* AOwner): TActiveForm(AOwner) {};
};
//---------------------------------------------------------------------------
extern PACKAGE TGuide *Guide;
//---------------------------------------------------------------------------



//---------------------------------------------------------------------------
class ATL_NO_VTABLE TGuideImpl:
  VCLCONTROL_IMPL(TGuideImpl, Guide, TGuide, IGuide, DIID_IGuideEvents)
{
...
//
BEGIN_COM_MAP(TGuideImpl)
  VCL_CONTROL_COM_INTERFACE_ENTRIES(IGuide)
END_COM_MAP()

//$$---- activex control license support (stActiveXControlLicensing)
  // Licensing support
  //
  typedef TLicenseString<TGuideImpl> TLicenseClassImpl;
  ...
  {
    return L"{336F3A0C-D264-44FA-A4F1-9141199A12D6}";
  }

  static const TCHAR* GetLicenseFileName()
  {
    return _T("GuideProj.lic");
  }
...
//
BEGIN_PROPERTY_MAP(TGuideImpl)
  // PROP_PAGE(CLSID_GuidePage)
END_PROPERTY_MAP()
...
DECLARE_VCL_CONTROL_PERSISTENCE(TGuideImpl, TGuide);
...
// your control.
//
DECLARE_ACTIVEXCONTROL_REGISTRY("GuideProj.Guide", 1);
