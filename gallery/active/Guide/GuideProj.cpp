...
#include "GuideImpl.h"
USEFORM("GuideImpl.cpp", Guide); /* TActiveForm: File Type */ /* Guide: CoClass */
//---------------------------------------------------------------------------
#pragma package(smart_init)
TComModule  GuideProjModule;
TComModule &_Module = GuideProjModule;
...
BEGIN_OBJECT_MAP(ObjectMap)
  OBJECT_ENTRY(CLSID_Guide, TGuideImpl)
END_OBJECT_MAP()
