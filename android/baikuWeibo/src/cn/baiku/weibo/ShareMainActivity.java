...
import cn.baiku.weibo.common.DialogUtils;
import cn.baiku.weibo.common.FileUtils;
import cn.baiku.weibo.common.InfoHelper;
import cn.baiku.weibo.common.MediaUtils;
import cn.baiku.weibo.common.StringUtils;
import cn.baiku.weibo.common.DialogUtils.DialogCallBack;
import cn.baiku.weibo.db.AccessInfoHelper;

import cn.baiku.weibo.R;
...
public class ShareMainActivity extends BaseActivity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		menu.add(0, TOOLBAR0, 1, "退出程序").setIcon(
				android.R.drawable.ic_menu_revert);
		menu.add(0, TOOLBAR1, 2, "注销登录").setIcon(
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		if (item.getItemId() == 0) {
			...
			DialogUtils.dialogBuilder(instance, "提示", "确定要注销登录并退出？",
					new DialogCallBack() {
						@Override
