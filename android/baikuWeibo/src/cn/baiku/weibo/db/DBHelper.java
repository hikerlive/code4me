...
public class DBHelper extends SQLiteOpenHelper {
	...
	private static final String CREATE_ACCESSINFO_LIB = "CREATE TABLE "
			+ ACCESSLIB_TABLE + " (" + AccessInfoColumn._ID
			+ " integer primary key autoincrement," + AccessInfoColumn.USERID
			+ " text," + AccessInfoColumn.ACCESS_TOKEN + " text,"
